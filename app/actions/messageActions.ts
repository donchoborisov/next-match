...
export async function getMessagesByContainer(container: string) {
    try {
        ...
        const conditions  = {
            [container  === 'outbox' ? 'senderId' : 'recepientId']: userId,
            ...(container === 'outbox' ? {senderDeleted: false} : {recepientDeleted: false})
        }
...
export async function deleteMessage(messageId: string, isOutbox:boolean) {
    ...
    const selector  = isOutbox ? 'senderDeleted' : 'recepientDeleted';
